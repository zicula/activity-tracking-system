...
โปรเจ็ค Activity-Log นี้พัฒนาขึ้นโดยใช้วิธีการ **Kiro-Style Development** ซึ่งเป็น approach ที่เน้นการสร้างเอกสารและความเป็นระเบียบ เลียนแบบการทำงานของ Kiro IDE จาก AWS
...
### สร้างโปรเจ็คใหม่:
```
Prompt: "ฉันต้องการสร้างระบบ Activity Log สำหรับติดตามกิจกรรมพนักงาน ใช้ Kiro workflow"
...
### เพิ่มฟีเจอร์ใหม่:
```
Prompt: "เพิ่มฟีเจอร์ real-time notifications ให้กับ Activity Log system ใช้ Kiro workflow"
...
1. **แก้ไข Master Prompt**
   ```
   เปลี่ยนชื่อโปรเจ็คจาก "Activity-Log" เป็นชื่อโปรเจ็คของคุณ
